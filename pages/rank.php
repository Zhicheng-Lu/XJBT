...
<div class="section">
    <div class="container" style="text-align: center;">
        ...
        <p style="margin-top: 15px; margin-left: auto; margin-right: auto; text-align: left; width: <?php echo 340+200*$num_competitions; ?>px; font-size: 8pt;"><?php echo $dict["rank_explanation"][$lang] ?></p>
   	</div>
</div>

<script type="text/javascript">
	function get_rank(order_competition_id, order, uid, lang) {
        ...
        xhttp.send("order_competition_id=" + order_competition_id + "&order=" + order + "&uid=" + uid + "&lang=" + lang);
    }

    get_rank(-1, "down", <?php echo $uid; ?>, "<?php echo $lang;?>");
</script>